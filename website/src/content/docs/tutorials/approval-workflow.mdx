...
- **[Signals Guide](/guides/signals/)** — Advanced signal patterns and best practices
- **[Webhooks Integration](/guides/webhooks/)** — Connect external systems via webhooks
- **[Timeout Strategies](/guides/timeouts/)** — Handle timeouts gracefully
- **[Multi-Step Approvals](/examples/multi-step-approval/)** — Chain multiple approval stages

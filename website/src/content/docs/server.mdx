...
> Sayiir Server is under active development. [Join the Discord](https://discord.gg/MWSzsHeg) for early access and to shape the roadmap.
...
[Join the Discord](https://discord.gg/MWSzsHeg) or [open an issue](https://github.com/sayiir/sayiir/issues) to get started.

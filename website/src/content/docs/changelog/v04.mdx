...
description: User-facing changes in Sayiir v0.4 — WorkflowClient for idempotent submission and centralized lifecycle control, breaking changes to WorkerHandle and CheckpointingRunner.
---
...
**Aging** prevents starvation: the longer a task waits, the more its effective priority improves. See [Task Priority](/guides/distributed-workers/#task-priority) for details.

...
- **AI agent example** — [`examples/ai-agent-cf`](https://github.com/sayiir/sayiir/tree/main/examples/ai-agent-cf) demonstrates fork/join, Workers AI iterative refinement, signal-based human approval, and cron-driven resume.

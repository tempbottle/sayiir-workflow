...
- **Task functions** — The executable code for each task node. In Python and Node.js, these are automatically extracted from the compiled `Workflow` objects. In Rust, you build a `TaskRegistry` explicitly.

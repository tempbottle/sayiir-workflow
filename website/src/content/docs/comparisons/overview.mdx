...
| Language SDKs | Rust, Python, Node.js / TS, Cloudflare Workers | Go, Java, TS, Python, .NET | Python | Python | Any (via Lambda) | C# (.NET) |
...
**Sayiir** supports Rust, Python, and Node.js / TypeScript, plus first-class Cloudflare Workers via a Rust/WASM build of the core. All language bindings share the same Rust runtime.

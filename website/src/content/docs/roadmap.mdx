---
title: Roadmap
description: What's planned for Sayiir — workflow context, loops, observability, child workflows, edge runtimes, and more
---

import { Card, CardGrid } from '@astrojs/starlight/components';

Sayiir is a durable workflow engine. It's great at what it does: checkpointed execution, parallel tasks, conditional branching, retries, signals, and crash recovery — all with zero infrastructure.

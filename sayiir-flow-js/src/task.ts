...
import type { RetryPolicyConfig, TaskMetadata } from "./interfaces.js";
...
function buildMetadata(id: string, opts?: TaskOptions): TaskMetadata {
...
function buildRetryPolicy(policy: RetryPolicy): RetryPolicyConfig {
  return {
